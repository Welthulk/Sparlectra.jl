...
function to_dict(result::SparlectraApiResult; include_raw_result::Bool = false)::Dict{String,Any}
  ...
  for key in ("qlimits_enabled", "qlimit_enforcement_mode", "qlimit_guard_enabled", "q_limit_preview_mode", "q_limit_runlog_max_rows", "runtime_casefile", "runtime_casefile_path")
