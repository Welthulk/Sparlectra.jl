...
Base.@kwdef struct StartModeConfig
  ...
  voltage_mode::Symbol = :bus_vm_va_blend
...
const POWERFLOW_START_VOLTAGE_MODE_VALUES = (:classic, :pv_gen_vg, :pv_bus_vm, :all_bus_vm, :bus_vm_va_blend)
...
function _validate_powerflow_solver_config!(raw::AbstractDict)
  ...
  sparse = _as_bool_cfg(_raw_get(pf, "sparse", _raw_get(pf, "opt_sparse", true)))
  _validate_rectangular_powerflow_options(method = method, sparse = sparse)
...
function StartModeConfig(raw::AbstractDict)
  ...
  voltage_mode = _validate_allowed_symbol("power_flow.start_mode.voltage_mode", _as_symbol_cfg(_raw_get(raw, "voltage_mode", :bus_vm_va_blend)), POWERFLOW_START_VOLTAGE_MODE_VALUES)
...
function PowerFlowConfig(raw::AbstractDict)
  ...
  sparse = _as_bool_cfg(_raw_get(merged, "sparse", _raw_get(merged, "opt_sparse", true)))
  _validate_rectangular_powerflow_options(method = method, sparse = sparse)
...
function StateEstimationConfig(raw::AbstractDict)
  ...
  return StateEstimationConfig(
    ...
    sparse = _as_bool_cfg(_raw_get(merged, "sparse", true)),
...
function MatpowerImportConfig(raw::AbstractDict)
  ...
  return MatpowerImportConfig(
    ...
    auto_profile = _validate_allowed_symbol("matpower_import.auto_profile", _as_auto_profile_symbol_cfg(_raw_get(merged, "auto_profile", _raw_get(merged, "matpower_auto_profile", :off))), MATPOWER_AUTO_PROFILE_VALUES),
    auto_profile_log = _as_bool_cfg(_raw_get(merged, "auto_profile_log", _raw_get(merged, "matpower_auto_profile_log", true))),
...
function DiagnosticsConfig(raw::AbstractDict)
  ...
  return DiagnosticsConfig(
    ...
    logfile_diagnostics = _validate_allowed_symbol("diagnostics.logfile_diagnostics", _as_symbol_cfg(_raw_get(merged, "logfile_diagnostics", :full)), OUTPUT_LOGFILE_DIAGNOSTICS_VALUES),
  )
end
