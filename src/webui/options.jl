...
const WEBUI_OPTION_SPECS = WebUIOptionSpec[
  ...
  WebUIOptionSpec("power_flow.apslf.order", "power_flow_apslf_order", Int, :number, 24, (), :expert, :case, true),
  ...
  WebUIOptionSpec(nothing, "gen_passive_as_zi", Bool, :checkbox, true, (), :basic, :case, true),
