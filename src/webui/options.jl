...
const WEBUI_OPTION_SPECS = (
  ...
  WebUIOptionSpec("runtime.parallel.enabled", "runtime_parallel_enabled", Bool, :checkbox, true, (), :expert, true),
  ...
  WebUIOptionSpec("power_flow.external_grid.enabled", "power_flow_external_grid_enabled", Bool, :checkbox, false, (), :expert, true),
  WebUIOptionSpec("power_flow.external_grid.source", "power_flow_external_grid_source", String, :select, "auto", EXTERNAL_GRID_SOURCE_VALUES, :expert, true),
  WebUIOptionSpec("power_flow.external_grid.sk_MVA", "power_flow_external_grid_sk_mva", Float64, :number, 2000.0, (), :expert, true),
  WebUIOptionSpec("power_flow.external_grid.rx", "power_flow_external_grid_rx", Float64, :number, 0.1, (), :expert, true),
  ...
  WebUIOptionSpec(nothing, "export_cgmes", Bool, :checkbox, false, (), :basic, true),
)
