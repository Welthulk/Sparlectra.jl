...
<label class=\"check\"><input name=\"power_flow_autodamp\" type=\"checkbox\"$(_webui_checked(profile_values, "power_flow_autodamp", _webui_option_default("power_flow_autodamp")))>$(_webui_field_label("power_flow_autodamp", "Autodamping enabled"))</label>
...
<label class=\"check\"><input name=\"power_flow_qlimits_enabled\" type=\"checkbox\"$(_webui_checked(profile_values, "power_flow_qlimits_enabled", _webui_option_default("power_flow_qlimits_enabled")))>$(_webui_field_label("power_flow_qlimits_enabled", "Q-limit handling enabled"))</label>
...
<fieldset class=\"span-2 detailed-csv-options\"><legend><label class=\"check\"><input name=\"detailed_result_csv\" type=\"checkbox\"$(_webui_checked(profile_values, "detailed_result_csv", _webui_option_default("detailed_result_csv")))>$(_webui_field_label("detailed_result_csv", "Export detailed result CSV files"))</label></legend>
...
$(config_maintenance)
<label class=\"check expert-diagnostics\"><input name=\"run_diagnostics\" type=\"checkbox\"$(_webui_checked(profile_values, "run_diagnostics", _webui_option_default("run_diagnostics")))>$(_webui_field_label("run_diagnostics", "Run diagnostics"))</label>
...
<label class=\"check span-2\"><input name=\"benchmark_enabled\" type=\"checkbox\"$(_webui_checked(profile_values, "benchmark_enabled", _webui_option_default("benchmark_enabled")))>$(_webui_field_label("benchmark_enabled", "Enable benchmark measurements"))</label>
