...
function with_powerflow_method(cfg::SparlectraConfig, method::Symbol)::SparlectraConfig
  ...
  return SparlectraConfig(; powerflow = pf2, state_estimation = cfg.state_estimation, matpower = cfg.matpower, matpower_export = cfg.matpower_export, transformer = cfg.transformer, performance = cfg.performance, benchmark = cfg.benchmark, runtime = cfg.runtime, diagnostics = cfg.diagnostics, output = cfg.output, control = cfg.control)
end
...
function _copy_config_with(cfg::SparlectraConfig; powerflow = cfg.powerflow, matpower = cfg.matpower)
  return SparlectraConfig(; powerflow = powerflow, state_estimation = cfg.state_estimation, matpower = matpower, matpower_export = cfg.matpower_export, transformer = cfg.transformer, performance = cfg.performance, benchmark = cfg.benchmark, runtime = cfg.runtime, diagnostics = cfg.diagnostics, output = cfg.output, control = cfg.control)
end
