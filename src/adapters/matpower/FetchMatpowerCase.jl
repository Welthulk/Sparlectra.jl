...
#
# file: src/adapters/matpower/FetchMatpowerCase.jl
...
"""
function emit_julia_case(mfile::AbstractString, outdir::AbstractString; legacy_compat::Bool = true, overwrite::Bool = false)::String
  mkpath(outdir)
...
"""
function ensure_matpower_case(; url::AbstractString, outdir::AbstractString, to_jl::Bool = true, overwrite::Bool = false, legacy_compat::Bool = true, verbose::Bool = true)
...
function parse_args(args::Vector{String})
  opts = Dict{String,Any}("url" => nothing, "outdir" => normpath(joinpath(@__DIR__, "..", "..", "..", "data")), "to_jl" => false, "overwrite" => false, "legacy_compat" => true)
...
function main(args = ARGS)
  ...
  ensure_matpower_case(url = url, outdir = opts["outdir"], to_jl = opts["to_jl"], overwrite = opts["overwrite"], legacy_compat = opts["legacy_compat"], verbose = true)
