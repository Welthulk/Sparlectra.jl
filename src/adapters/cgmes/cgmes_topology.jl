...
# file: src/adapters/cgmes/cgmes_topology.jl
...
- `bus_name`: TopologicalNode mRID → unique Sparlectra bus name
  (`IdentifiedObject.name`, mRID-suffixed only on collision).
