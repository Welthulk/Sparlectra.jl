...
# file: src/acpflow/solver_interface.jl
...
AnalyticLoadFlow.jl is a required dependency of Sparlectra, so the solver is
always available: `using Sparlectra` is enough, and the result goes straight to
