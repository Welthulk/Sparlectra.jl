...
function _rectangular_status_diagnostics(rect_status)::NamedTuple
  return (
    ...
    final_q_check_status = _rect_status_get(rect_status, :final_q_check_status, :not_evaluated),
    final_q_check_rows = _rect_status_get(rect_status, :final_q_check_rows, NamedTuple[]),
    final_q_check_max_dev_pu = _rect_status_get(rect_status, :final_q_check_max_dev_pu, 0.0),
    final_q_check_buses = _rect_status_get(rect_status, :final_q_check_buses, ""),
    ...
    merit_enabled = _rect_status_get(rect_status, :merit_enabled, false),
    merit_used_iterations = _rect_status_get(rect_status, :merit_used_iterations, 0),
    merit_fallback_count = _rect_status_get(rect_status, :merit_fallback_count, 0),
    merit_active_set_skip_count = _rect_status_get(rect_status, :merit_active_set_skip_count, 0),
    merit_initial = _rect_status_get(rect_status, :merit_initial, NaN),
    merit_final = _rect_status_get(rect_status, :merit_final, NaN),
    merit_linesearch_artifact = _rect_status_get(rect_status, :merit_linesearch_artifact, ""),
    trust_region_enabled = _rect_status_get(rect_status, :trust_region_enabled, false),
    tr_step_count = _rect_status_get(rect_status, :tr_step_count, 0),
    tr_rejected_steps = _rect_status_get(rect_status, :tr_rejected_steps, 0),
    tr_min_radius = _rect_status_get(rect_status, :tr_min_radius, NaN),
    tr_max_radius = _rect_status_get(rect_status, :tr_max_radius, NaN),
    tr_final_radius = _rect_status_get(rect_status, :tr_final_radius, NaN),
    tr_collapsed = _rect_status_get(rect_status, :tr_collapsed, false),
    tr_dogleg_newton_count = _rect_status_get(rect_status, :tr_dogleg_newton_count, 0),
    tr_dogleg_interp_count = _rect_status_get(rect_status, :tr_dogleg_interp_count, 0),
    tr_dogleg_cauchy_count = _rect_status_get(rect_status, :tr_dogleg_cauchy_count, 0),
    tr_active_set_skip_count = _rect_status_get(rect_status, :tr_active_set_skip_count, 0),
    trust_region_artifact = _rect_status_get(rect_status, :trust_region_artifact, ""),
