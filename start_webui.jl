...
function main()
  server = start_sparlectra_webui(host = "127.0.0.1", port = 8080, output_root = joinpath(@__DIR__, "_out", "powerflow_service"), open_browser = true, auto_shutdown_on_browser_close = true, browser_heartbeat_timeout_seconds = 15.0)
