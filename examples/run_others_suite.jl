...
const SUITE_SPECS = ExampleSpec[
  ...
  ExampleSpec(name = "open_terminal_line", file = "others/exp_open_terminal_line.jl", purpose = "one-sided open line (r0.10.0): full charging draw at the closed bus, r loss of the charging current, Ferranti rise at the open end"),
