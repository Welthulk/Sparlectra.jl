...
# Date: 2026-07-24
# file: examples/mc_state_estimation_study.jl
...
function main()
  print_example_banner("examples/mc_state_estimation_study.jl", "Monte-Carlo WLS state-estimation error study on the 7-bus workshop network")
