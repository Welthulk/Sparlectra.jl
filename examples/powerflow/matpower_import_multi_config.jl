...
# Date: 2026-05-29
# file: examples/powerflow/matpower_import_multi_config.jl
...
Usage:
  julia --project=. examples/powerflow/matpower_import_multi_config.jl CASEFILE [options]
...
"""
function main()
  print_example_banner("examples/powerflow/matpower_import_multi_config.jl", "compares one MATPOWER case against one or more YAML configuration files to check whether config choices change the final rectangular PF status")
