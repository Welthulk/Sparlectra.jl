...
function main_nose_curve_comparison()
  print_example_banner("examples/powerflow/apslf_demo.jl (nose-curve comparison)", "compares plain flat-start NR, standalone APSLF, and NR seeded with APSLF start values across a PV-curve voltage-stability nose")
