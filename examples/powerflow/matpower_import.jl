...
# Date: 2026-05-18
# file: examples/powerflow/matpower_import.jl
...
"""
function main()
  print_example_banner("examples/powerflow/matpower_import.jl", "CLI runner that imports a MATPOWER case via run_matpower_case using the resolved Sparlectra configuration, with optional Julia-thread re-exec")
