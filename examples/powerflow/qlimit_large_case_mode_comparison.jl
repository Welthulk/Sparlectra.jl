...
# Date: 2026-06-19
# file: examples/powerflow/qlimit_large_case_mode_comparison.jl
...
function main(args = ARGS)
  print_example_banner("examples/powerflow/qlimit_large_case_mode_comparison.jl", "compares Q-limit large-case start-profile/enforcement-mode combinations across configured MATPOWER cases (experimental diagnostic tooling)")
