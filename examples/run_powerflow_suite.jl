...
const SUITE_SPECS = ExampleSpec[
  ...
  ExampleSpec(name = "qlimit_reenable_voltage_rule", file = "powerflow/example_qlimit_reenable_voltage_rule.jl", purpose = "voltage-side PQ->PV release of the active-set mode on the Zeng/Chiang 14-bus case, against the classic one-at-a-time mode"),
