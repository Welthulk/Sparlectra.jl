...
function run_usage_state_estimation_diagnostics()
  print_example_banner("examples/state_estimation/usage_state_estimation_diagnostics.jl", "demonstrates bad-data diagnostics for state estimation: inject one bad measurement, run validate_measurements, and inspect deactivate-and-rerun diagnostics")
