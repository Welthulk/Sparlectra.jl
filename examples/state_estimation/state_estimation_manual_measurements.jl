...
# Date: 2026-03-18
# file: examples/state_estimation/state_estimation_manual_measurements.jl
...
function main()
  print_example_banner("examples/state_estimation/state_estimation_manual_measurements.jl", "demonstrates building a state-estimation measurement set with the manual measurement helpers (addVmMeasurement!, addPinjMeasurement!, ...) instead of raw Measurement(...) construction")
