...
# Date: 2026-03-13
# file: examples/state_estimation/state_estimation_wls.jl
...
function main()
  print_example_banner("examples/state_estimation/state_estimation_wls.jl", "runs a first classical WLS state-estimation workflow: build/import network, solve PF, generate synthetic measurements, and estimate the state")
  mkpath(OUTDIR)
