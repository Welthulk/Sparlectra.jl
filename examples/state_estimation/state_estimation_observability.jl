...
# Date: 2026-03-13
# file: examples/state_estimation/state_estimation_observability.jl
...
"""
function main()
  print_example_banner("examples/state_estimation/state_estimation_observability.jl", "progressively deactivates branch-flow measurements and logs global/local observability-redundancy metrics and warnings when local observability is lost")
  mkpath(OUTDIR_OBS)
