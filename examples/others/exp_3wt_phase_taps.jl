...
# Date: 2026-07-20
# file: examples/others/exp_3wt_phase_taps.jl
...
"""
function main()
  print_example_banner("examples/others/exp_3wt_phase_taps.jl", "builds a 3WT in three tap configurations (OLTC only, PST/Schraegregler only, both combined) and solves each with runpf!, demonstrating create3WTWindings!'s phase_tap_side/phase_taps keywords")
