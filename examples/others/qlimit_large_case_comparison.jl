...
# file: examples/others/qlimit_large_case_comparison.jl
...
function _extract_effective_matpower_import(effective_config_path::AbstractString, auto_profile_log_path::AbstractString)
  ...
  if isfile(effective_config_path)
    try
      ...
      values["auto_profile"] = String(cfg.model.auto_profile)
      ...
      values["bus_shunt_model"] = String(cfg.model.bus_shunt_model)
