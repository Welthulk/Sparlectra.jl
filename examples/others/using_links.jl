...
# file: examples/others/using_links.jl
# Date: 2026-03-10
...
function main(; args = ARGS)
  print_example_banner("examples/others/using_links.jl", "example network with a busbar coupler (Bus1 <-> Bus1a) modeled as a Sparlectra bus link, demonstrating open/close link behavior")
  _ = args
