...
function main(args = ARGS)
  print_example_banner("examples/others/export_solution.jl", "runs Sparlectra's internal solver, exports a solver-agnostic PFModel/PFSolution, and optionally compares against an external-solver run via runpf_external!")
