...
# Date: 2026-04-24
# file: examples/others/tap_control_demo_grid.jl
...
function main(args::AbstractVector{String} = ARGS)
  print_example_banner("examples/others/tap_control_demo_grid.jl", "lightweight three-controller demo (OLTC + PST + Schraegregler) via run_sparlectra(net=...), reporting controller/trace rows from latest_control_result(net)")
