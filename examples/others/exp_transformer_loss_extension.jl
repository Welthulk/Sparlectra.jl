...
# Date: 2026-07-13
# file: examples/others/exp_transformer_loss_extension.jl
...
function main(; output_dir = joinpath(@__DIR__, "..", "_out", "transformer_loss_extension"))
  print_example_banner("examples/others/exp_transformer_loss_extension.jl", "demonstrates Sparlectra's MATPOWER transformer-loss extension by exporting a small transformer case with active no-load conductance metadata and reimporting it losslessly")
  mkpath(output_dir)
