...
function main()
  ...
  println("  open-end voltage   : ", round(br.open_end_vm_pu; digits = 5), " pu at ", round(br.open_end_va_deg; digits = 3), " deg (Ferranti rise above the ", round(get_bus_vm_pu(net2, "A"); digits = 5), " pu at A)")
