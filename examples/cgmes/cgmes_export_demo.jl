...
# file: examples/cgmes/cgmes_export_demo.jl
...
function main(; output_dir::AbstractString = joinpath(@__DIR__, "..", "_out", "cgmes_export"))
  print_example_banner("examples/cgmes/cgmes_export_demo.jl", "demonstrates the CGMES export (writeCGMESFiles) on a small programmatically built network")
