...
release asset, generated by CI. It lists the full dependency tree with
licenses; since no `Manifest.toml` is checked in, it describes the
resolution at generation time (stated in its `CreatorComment`). Generate
