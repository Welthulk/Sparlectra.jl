...
function test_configuration_yaml_key_coverage()
  @testset "Configuration YAML key coverage" begin
    ...
    mapped_keys = Set([
      ...
      "power_flow.qlimits.enabled", "power_flow.qlimits.enforcement_mode", "power_flow.qlimits.start_iter", "power_flow.qlimits.start_mode", "power_flow.qlimits.auto_q_delta_pu", "power_flow.qlimits.hysteresis_pu", "power_flow.qlimits.cooldown_iters", "power_flow.qlimits.reenable_v_hyst_pu", "power_flow.qlimits.trace_buses", "power_flow.qlimits.lock_pv_to_pq_buses",
    ...
    expected_consumers = Dict(
      ...
      "power_flow.apslf.convergence_radius" => :ApslfConfig,
