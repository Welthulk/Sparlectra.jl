...
function run_configuration_coverage_tests()
  @testset "Configuration YAML leaf coverage" begin
    ...
    mapped_or_reserved = Set([
      "power_flow.method", "power_flow.sparse", "power_flow.flatstart", "power_flow.tol", "power_flow.max_iter", "power_flow.autodamp", "power_flow.autodamp_min", "power_flow.rectangular_workspace_reuse", "power_flow.rectangular_preallocate_workspace", "power_flow.rectangular_workspace_min_buses",
