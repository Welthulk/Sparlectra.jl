...
#                                                                             #src
# file: docs/lit/workshop_se_diagnostics.jl                                   #src
# purpose: Literate.jl source of the SE diagnostics workshop notebook and its #src
#          Documenter page: bad-data localization, sequential elimination,    #src
#          robust estimation, current measurements, shunt estimation.         #src
