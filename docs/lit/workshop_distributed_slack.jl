...
#                                                                             #src
# file: docs/lit/workshop_distributed_slack.jl                                #src
# purpose: Literate.jl source of the distributed-slack workshop notebook and  #src
#          its Documenter page: why a single slack bus is a modeling          #src
#          artifact, how the participation weights (p_mode) are determined,   #src
#          how they are normalized, and what happens when no valid            #src
#          participant exists. Regenerate the committed outputs with          #src
