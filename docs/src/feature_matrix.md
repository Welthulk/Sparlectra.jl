...
|---|:---:|:---:|---|
| Framework workflow | ✅ | — | `run_sparlectra` is the preferred configuration-driven import/control/solve/output entry point and always returns `SparlectraRunResult`; `run_acpflow` is its thin AC power-flow alias. |
