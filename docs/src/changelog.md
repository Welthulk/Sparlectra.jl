...
* **Feature**: Added a local PowerFlow service boundary with run-specific output directories, run-ID lookup, artifact listing, and traversal-safe artifact resolution for future thin Genie.jl routes.
