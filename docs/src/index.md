...
The notebooks are generated from the Literate.jl sources in [docs/lit/](https://github.com/Welthulk/Sparlectra.jl/tree/main/docs/lit/); the same content is on the documentation pages under [Notebooks](https://welthulk.github.io/Sparlectra.jl/generated/workshop_tour/).
...
[tools/install_webui.sh](https://github.com/Welthulk/Sparlectra.jl/blob/main/tools/install_webui.sh) or
[tools/install_webui.bat](https://github.com/Welthulk/Sparlectra.jl/blob/main/tools/install_webui.bat) before running them, or
...
[![Sparlectra Web UI: case, settings, run and result](assets/webui_v0.10.0.png)](assets/webui_v0.10.0.png)

**Power flow run & history**: result with convergence report (left) and the run history (right):

[![Sparlectra Web UI: PowerFlow result and run history](assets/webui_powerflow_history.png)](assets/webui_powerflow_history.png)
...
- [Workshop Tour](generated/workshop_tour.md): building and manipulating network models step by step
- [Import/Export](import.md) · [CGMES Import](cgmes_import.md) · [CGMES Export](cgmes_export.md): reading and writing grid data
- [Short-Circuit Analysis](short_circuit.md): balanced short-circuit currents per IEC 60909-0
- [Branch Model](branchmodel.md) · [Remote Voltage Control](remote_voltage_control.md): line/transformer modeling, tap and voltage control
- [Solver Guide](solver.md) · [External Solvers](external_solvers.md): numerical formulations and the `PFModel`/`PFSolution` interface
- [State Estimation](state_estimation.md): WLS state-estimation workflow
- [Feature Matrix](feature_matrix.md): capability overview
- [Function Reference](reference.md) · [Workshop tour](generated/workshop_tour.md): API reference and guided examples
...
Please read [CONTRIBUTING.md](https://github.com/Welthulk/Sparlectra.jl/blob/main/CONTRIBUTING.md) and [CODE_OF_CONDUCT.md](https://github.com/Welthulk/Sparlectra.jl/blob/main/CODE_OF_CONDUCT.md) before contributing.
...
See [LICENSE](https://github.com/Welthulk/Sparlectra.jl/blob/main/LICENSE) for the full license text.
```@raw html
