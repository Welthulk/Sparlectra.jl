...
| `webui` | `test/test_webui.jl` | Public Web UI binding, allowlisted form mapping, service-backed runs, shared logo/header rendering, exact PNG asset routing, result/artifact/history HTML, traversal rejection, absence of direct solver calls, and loopback HTTP smoke requests |
