...
| `programmatic_api` | `test/test_api.jl` | GUI-ready power-flow API success/failure status, override validation, effective configuration, artifact discovery, and Dict/NamedTuple/JSON/YAML serialization |
