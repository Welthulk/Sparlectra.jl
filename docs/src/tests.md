...
| `webui` | `test/test_webui.jl` | Public Web UI binding, allowlisted form mapping, service-backed runs, result/artifact/history HTML, traversal rejection, absence of direct solver calls, and a loopback HTTP smoke request |
