...
and CGMES deliveries, which cannot be synthesized. The former case14
self-check anchor is gone: the shipped sp_case14 anchor two lines above it
fixes the same reference.
