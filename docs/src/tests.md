...
| `configuration` | `test/test_configuration_coverage.jl`, `test/test_runner_helpers.jl` | Configuration-key coverage, safe refresh checks, forwarding checks, start-voltage value-domain validation, and test-runner output-mode helper checks |
